...
::============================================================================================
:    Credits: Web4Crypto.io   ijazsialkwl
::============================================================================================
::
...
::  Thanks to @ijazsialkwl for the powershell method and solving special characters issue in file path name.
...
cls
title  IDM Activation v0.5 - web4crypto.io
mode 90, 30
...
echo:
echo:
echo:                             web4crypto.io Presents
echo:                             ijazsialkwl Presents
echo:  
...
set "reg=HKCU\SOFTWARE\DownloadManager /v FName /t REG_SZ /d "igetintopc.com"" & call :_rcont
